...
import HamburguerIcon from '../../layout/HamburguerLayout';
    ...
    return (
        <div className="w-full z-20 bg-pwgreen-100 p-4 flex items-center justify-between sticky top-0 border border-b-pwgreen-800 border-opacity-30 shadow-md lg:static lg:border-none">
            <div className="flex gap-2 items-center">
                ...
                <Link href={'/'} className="text-xl border rounded-full border-pwgreen-700 p-2 text-pwgreen-700 hover:bg-pwgreen-700 hover:text-pwgreen-100 transition-colors">
                    <FaArrowLeft />
                </Link>
